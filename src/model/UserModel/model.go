...
type UserLoginInfoImpl struct {
	...
	Name       string `binding:"required" gorm:"column:u_name" json:"username,omitempty" form:"username"`
	PassWord   string `binding:"required" gorm:"column:u_password" json:"password,omitempty" form:"passwordgit"`
